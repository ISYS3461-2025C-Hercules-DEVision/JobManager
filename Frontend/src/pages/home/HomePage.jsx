      ...
      <header className="border-b-4 border-black bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="text-2xl font-black text-black uppercase tracking-tight">DEVision.Manager</div>
            
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#recruitment" className="text-black font-bold uppercase text-sm hover:bg-black hover:text-white px-3 py-2 transition-none">Recruitment</a>
              <a href="#pricing" className="text-black font-bold uppercase text-sm hover:bg-black hover:text-white px-3 py-2 transition-none">Pricing</a>
              <span className="text-sm font-bold uppercase">VN | EN</span>
            </nav>
            
            <div className="flex items-center space-x-4">
              <Link to="/login" className="text-black font-bold uppercase text-sm border-2 border-black px-4 py-2 hover:bg-black hover:text-white transition-none">
                Get started!
              </Link>
              <Link 
                to="/register" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="border-4 border-black bg-white p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <h3 className="text-2xl font-black text-black mb-4 uppercase">Transparent Hiring</h3>
            ...
            <div className="border-4 border-black bg-white p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <h3 className="text-2xl font-black text-black mb-4 uppercase">Talent Search</h3>
              <p className="text-black font-bold leading-relaxed">
            ...
            <div className="border-4 border-black bg-white p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <h3 className="text-2xl font-black text-black mb-4 uppercase">Verified Talent</h3>
              <p className="text-black font-bold leading-relaxed">
      ...
      <section id="pricing" className="py-20 bg-light-gray border-b-4 border-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black text-black mb-4 uppercase">Talent Search</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white border-4 border-black p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-black font-bold">3 Job Postings Daily</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary font-black text-2xl mr-3">✓</span>
                  <span className="text-black font-bold">Basic Candidate Search</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary font-black text-2xl mr-3">✓</span>
            ...
            <div className="bg-primary border-4 border-black p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-white font-bold">15 Job Postings Daily</span>
                </li>
                <li className="flex items-start">
                  <span className="text-white font-black text-2xl mr-3">✓</span>
                ...
                <li className="flex items-start">
                  <span className="text-white font-black text-2xl mr-3">✓</span>
                  <span className="text-white font-bold">Candidate Contact</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border-4 border-black p-8 hover:translate-x-2 hover:translate-y-2 hover:shadow-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-none">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-primary font-black text-2xl mr-3">✓</span>
                  <span className="text-black font-bold">Unlimited Jobs Posting</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary font-black text-2xl mr-3">✓</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-black mb-4 uppercase">DEVision.Manager</h3>
              <p className="text-white font-bold mb-6 leading-relaxed border-l-4 border-primary pl-4">
                The simplest applicant-tracking system for tech top talent without the noise.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 font-bold">
                <li><a href="#" className="hover:underline underline-offset-4 decoration-4">Find Talent</a></li>
                <li><a href="#" className="hover:underline underline-offset-4 decoration-4">Post A Job</a></li>
                <li><a href="#" className="hover:underline underline-offset-4 decoration-4">Pricing</a></li>
                <li><a href="#" className="hover:underline underline-offset-4 decoration-4">Enterprise</a></li>
              </ul>
            </div>
